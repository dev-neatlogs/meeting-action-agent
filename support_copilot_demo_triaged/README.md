...
- Prompt v3 no longer hardcodes a refund window; escalates KB/customer conflicts to a supervisor
- Current refund policy (v3.0) uses a 30-day window aligned with the public FAQ
